                            ...
                            {recentSessions.length > 0 ? (
                                <div className="flex flex-col gap-4 pb-4">
                                    {recentSessions.map((session) => {
                                        // For curated model, we need to find video by videoId
                                        return (
                                            <div key={session.id} onClick={() => router.push(`/session/${session.videoId}`)} className="cursor-pointer">
                                                <SessionCard
                                                    title={`Video ${session.videoId}`}
                                                    thumbnailUrl={`https://img.youtube.com/vi/${session.videoId}/mqdefault.jpg`}
