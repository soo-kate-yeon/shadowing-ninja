        ...
        <div className="min-h-screen bg-secondary-200 flex flex-col">
            ...
            <main className="flex-1 max-w-[600px] w-full mx-auto p-8 flex flex-col gap-6">
                ...
                <section className="bg-surface rounded-2xl p-6 border border-secondary-200 shadow-sm">
                    <h2 className="text-2xl font-semibold text-neutral-900 mb-4">계정 정보</h2>
                ...
                <section className="bg-surface rounded-2xl p-6 border border-secondary-200 shadow-sm">
                    <h2 className="text-2xl font-semibold text-neutral-900 mb-4">학습 현황</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-secondary-50 rounded-xl p-4 border border-secondary-200">
                            ...
                            <p className="text-3xl font-bold text-primary-500">{activeSessionsCount}</p>
                        </div>
                        <div className="bg-secondary-50 rounded-xl p-4 border border-secondary-200">
                ...
                <section className="bg-surface rounded-2xl p-6 border border-secondary-200 shadow-sm">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-2xl font-semibold text-neutral-900">플랜 정보</h2>
                    ...
                    <Button
                        ...
                        variant="outline"
                        className="w-full border-2 border-primary-500 text-primary-600 hover:bg-primary-50 font-semibold py-3 rounded-xl transition-colors"
                    >
                        플랜 업그레이드
                    </Button>
                </section>
